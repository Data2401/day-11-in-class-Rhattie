...
```{r}
USPersonalExpenditure$Catergory <- rownames(USPersonalExpenditure)
data.frame(USPersonalExpenditure)
```
...
```{r}
#USPersonalExpenditure<- pivot_longer (USPersonalExpenditure), #c((("X1940","X1945","X1950","X1955","X1960")),name_to = "year" , values to "Money_Spent")
```
